...
export default function Home() {
  ...
  return (
    <AnimatePresence>
      <div className="flex relative bg-[#F2F3F5] overflow-hidden">
        <svg
        ...
        <main className="flex flex-col justify-center h-[100%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          >
            PeepCoin
            <span className="font-inter text-[#407BBF]">{">"}_</span>
          </motion.h1>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex gap-[15px] mt-8 md:mt-0">
            ...
            >
              <Link
                href="https://github.com/purav10/PeepCoin/"
                target="_blank"
        ...
        ></motion.canvas>
        <div className="h-[60px] bg-[#1D2B3A] fixed bottom-0 z-20 w-full flex flex-row items-center justify-evenly left-0">
        </div>
      </div>
    </AnimatePresence>
  );
